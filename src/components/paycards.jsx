            ...
            <div className="cards">
                <div className="card">
                    <div className="card__img">
                        <img src="images/logo2.jpg" alt="bu logotip" width={30}/>
                    </div>
                ...
                <div className="card">
                    <div className="card__img">
                        <img src="images/apelsin.jpg" alt="bu logotip" width={50}/>
                        <img src="images/click.jpg" alt="bu logotip" width={40}/>
                        <img src="images/payme.png" alt="bu logotip" width={40}/>
                    </div>
                    <p className="card__text">Payme, Click yoki Apelsin kabi boshqa mobil ilovalar orqali to’lov amalga oshirishiz mumkin</p>
                </div>
                <div className="card">
                    <div className="card__img">
                        <img src="images/paynet.jpg" alt="bu logotip" width={30}/>
                    </div>
